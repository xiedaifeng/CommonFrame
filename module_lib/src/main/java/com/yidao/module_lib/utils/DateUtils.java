...
public class DateUtils {
    ...
    public static String stampToDateFormat(Date strDate,String format){
        SimpleDateFormat formatter = new SimpleDateFormat(format);
        String dateString = formatter.format(strDate);
        return dateString;
    }
    public static String stampToDateFormat(long time,String format){
        SimpleDateFormat formatter = new SimpleDateFormat(format);
    ...
    private static boolean isNow(long date) {
        ...
        //对比的时间
        String day = sf.format(new Date(date));
    ...
    public static String getTimeDistance(long time){
        ...
        if (isNow(time)){
            ...
            return convertTimeToFormat(time);
     ...
     * @return
     */
    public static long timeToMilliSecond(String time,String format){
        ...
        try {
            ...
            long t1time=Long.parseLong(t1.toString());
