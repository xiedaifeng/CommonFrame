...
public class Constants {
    ...
    //sharePreference 的 key,判断是否显示引导页
...
//    //当收到通知或者
//    public static final String SHOW_QUIT_DIALOG = "showQuitDialog";
    ...
    public static final String ROLE_TYPE = "ruleType";
    ...
    public static final String CUSTOM_ID = "customId";//客户id
}
